  ...
  return (
    <div className="my-5 flex flex-col space-y-5 px-10">
      <div className="text-2xl font-semibold">
        Dashboard{' '}
        <a className='text-sm' href="itms-services://?action=download-manifest&url=https://firebasestorage.googleapis.com/v0/b/storage-app-5f90b.appspot.com/o/Shabika%20iOS%2Fmanifest.plist?alt=media&token=67160679-fcfe-41c3-94de-059564c79606&_gl=1*1whcwuk*_ga*MzcwNDM3MzAuMTY3NjQ2NDkwMA..*_ga_CW55HF8NVT*MTY4NTQzMDgxMy4xNC4xLjE2ODU0MzEzMDAuMC4wLjA.">
          Install iOS App
        </a>
      </div>
