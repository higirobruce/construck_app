...
const OperatorCard = (props) => {
    ...
    return (
        <>
            {(role == 'teamLeader') && <div className={`${teamApproval == true ? 'bg-green-100 text-green-500' : "bg-red-100 text-red-500"} px-5 py-2 w-1/2`}>
            ...
            {(role == 'supervisorWorkshop') && <div className={`${teamApproval == true ? 'bg-green-100 text-green-500' : "bg-red-100 text-red-500"} px-5 py-2 w-1/2`}>
                <span className='text-center font-normal'>
